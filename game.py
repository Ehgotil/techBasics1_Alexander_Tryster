...
#AI was used to implement and explain the choice system to me.
...
if choice == "rope":
    ...
    if choice == "jump":
        print("You sneak across the lot, throwing glances over your shoulder, but the guard seems to pay you no mind. One time it looks like he picks up the phone, but nothing happens, so you feel comfortable to clamber up and over the gate. You slip up once and tear your pants, but you have bigger fish to fry. You drop down into the weeds behind the gate and start jogging. The edge of the premises is in sight. You’re almost at the edge, when you hear someone coming. You duck down into the bushes and peer out from between the branches. A guy with a flat top and an insane grin is staring out from behind his shades. “You weren’t that dumb”, he says. “Almost got away with it, too. But sadly…” His voice trails off. He sighs and suddenly pulls out a handgun. Before you can react he has pulled the trigger and your whole world is going dark. In you final moments, you feel the wind whipping up and all of a sudden… ")
        print("(Please restart the experience and try again.)")
time.sleep(100)
# Academiccloud AI was used to explain and fix a bug where the prompt to enter the code was duplicated. Additionally, AI was used to explain the implementation of the choice mechanic, i.e. implementing a string.